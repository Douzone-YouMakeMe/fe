  ...
  return (
    ...
    >
      ...
      <Row gutter={[]}>
        ...
        <Col span={10}>
          <input type="file" onChange={(e) => { handleThumbnailChange(e.target.files[0]) }}></input>
        </Col>
      </Row>
      <br></br>
      <br></br>
      <Row gutter={[]}>
        ...
        <Col span={16}>
          <Input value={name} style={{ width: 280 }} onChange={handleNameChange}></Input>
        </Col>
      </Row>
      <br></br>
      <Row gutter={[]}>
        ...
        <Col span={16}>
          <Input value={description} style={{ width: 280 }} onChange={handleDescriptionChange} ></Input>
        </Col>
      </Row>
      <br></br>
